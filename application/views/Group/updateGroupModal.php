...
<!-- Modal -->
<div class="modal fade" id="modalUpdateGroup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-header">
        <span class="modal-title" id="modalUpdateGroupHeader" style="font-weight: bold;font-size: 16px;">Update Group</span>
