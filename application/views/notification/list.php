<div class="content-wrapper" style="min-height: 98px;">
  <section class="content-header">
    <h1>
      Groups <small>Manager</small>
    </h1>
    <ol class="breadcrumb">
      <li><i class="fa fa-dashboard"></i> Groups</li>
      ...
      <div class="col-xs-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <div class="pull-left">
              <h3 class="box-title"><i class="fa fa-list" aria-hidden="true"></i> List of Groups</h3>
            </div>
            <div class="pull-right">
              <a class="btn btn-flat btn-primary btn-md" id="btnCreateGroup" title="Create New Group"><i class="fa fa-plus" aria-hidden="true"></i> Create Group</a>
            </div>
          </div>

          <div class="box-body">
            <table class="table table-bordered table-hover" id="groupTable" style="width: 100%">
              <thead>
  ...
  function datatable() {
    ...
    $('#groupBody').on('click', '.btnUpdate', function() {
      var data = ($(this).parents('tr').hasClass('child')) ?
        groupTable.row($(this).parents().prev('tr')).data() // if tr is a child, then get the parents
        :
        groupTable.row($(this).parents('tr')).data(); // otherwise get original data
      $('#id').val(data.id);
