<div class="content-wrapper" style="min-height: 98px;">
    ...
    <section class="content-header">
    	<h1> Permissions <small>Manager</small> </h1>
    	<ol class="breadcrumb">
    		<li><i class="fa fa-dashboard"></i> Permissions</li>
    		<li class="active"> Set Permissions</li>
    	</ol>
    </section>
			...
			<div class="col-xs-12">
				<div class="box box-default">
					<div class="box-header with-border">
						<div class="pull-left">
							<h3 class="box-title"><i class="fa fa-check" aria-hidden="true"></i> Set Permissions</h3>
						</div>
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-sm-12">
								<ul class="list-group">
									<li class="list-group-item"><input class="form-check-input" type="checkbox" id="cbx_um"><b> ALLOW ALL PERMISSIONS</b></li>
								</ul>
							</div>
